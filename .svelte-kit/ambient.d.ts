...
declare module '$env/static/private' {
	...
	export const EASYBUILD_MODULES_TOOL: string;
	...
	export const EASYBUILD_PREFIX: string;
	...
	export const VIMINIT: string;
	export const LS_COLORS: string;
	export const LLVMPATH: string;
